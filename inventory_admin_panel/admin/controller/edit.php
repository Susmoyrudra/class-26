...
<?php
    $edit_id = $_GET['id'];
    $show_sql = "SELECT * FROM sub_categories WHERE cat_type_id = '$edit_id'";
    ...
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        if(empty($sub_cat_name) || empty($sub_cat_code)){
            if(empty($sub_cat_code) && empty($sub_cat_code)){
             ...
             // echo "1";
             $sql = "UPDATE sub_categories SET sub_cat_name='$sub_cat_name', sub_type_code='$sub_cate_code' WHERE sub_cat_id='$edit_id'";
